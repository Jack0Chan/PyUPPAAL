...
class Tracer:
    ...
    """
    @staticmethod
    def get_timed_trace(model_path: str, xtr_trace_path: str, no_temp = True) -> SimTrace | None:
        ...
        """
        if_name = Verifyta().compile_to_if(model_path=model_path)
        trace_text = utap_parser(if_name, xtr_trace_path)
